...
<head>
  ...
  <meta name="author" content="Ozan Kurt">
...
<body id="body" data-spy="scroll" data-target=".one-page-header" class="demo-lightbox-gallery lawyer-style">
    <main class="wrapper">
            ...
            <div class="container">
                <div class="menu-container page-scroll">
                    ...
                    <a class="navbar-brand" href="#body">
                        <img src="/assets/custom/logo.png" alt="Logo">
                    </a>
                </div>
                    ...
                    <div class="menu-container">
                        <ul class="nav navbar-nav">
                            <li class="page-scroll">
                                <a href="#services"><span data-hover="Hizmetlerimiz">Hizmetlerimiz</span></a>
                            </li>
                            <li class="page-scroll">
                                <a href="#why-us"><span data-hover="Bizi Özel Kılanlar">Bizi Özel Kılanlar</span></a>
                            </li>
                            <li class="page-scroll">
                                <a href="#contact"><span data-hover="İletişim">İletişim</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="promo g-theme-bg-color-1">
            <div class="rev_slider_wrapper fullwidthbanner-container" data-alias="image-hero20">
                ...
                <div id="rev_slider_20_1" class="rev_slider fullwidthabanner" style="display: none;" data-version="5.0.7">
                    <ul>
                        <!-- SLIDE  -->
                        <li data-index="rs-68" data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/custom/promo/img1.jpg" data-rotate="0" data-saveperformance="off" data-title="Intro" data-description="">

                            <!-- MAIN IMAGE -->
                            <img src="/assets/custom/promo/img1.jpg" alt="" data-bgposition="50% 10%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            ...
                            <div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
                                ...
                                style="z-index: 7; white-space: nowrap; text-align: center; text-transform: none;">Kiraz Bahçesi
                            </div>
                            ...
                            <div class="tp-caption NotGeneric-SubTitle tp-resizeme rs-parallaxlevel-0"
                                ...
                                style="z-index: 8; white-space: nowrap; text-align: center; text-transform: none;">Reklam ve Prodüksiyon Hizmetleri
                            </div>
                            ...
                            <div class="tp-caption NotGeneric-CallToAction rev-btn rs-parallaxlevel-0"
                                ...
                                style="z-index: 9; font-weight: bold; white-space: nowrap; outline: none; box-shadow: none; box-sizing: border-box; text-transform: none; border-width: 2px;">Bilgi Alın
                            </div>
                        </li>
                    </ul>
        ...
        @include('layout.sections.why-us')

        {{-- @include('layout.sections.benefits') --}}

        {{-- @include('layout.sections.our-cases') --}}

        {{-- @include('layout.sections.team') --}}
        ...
        <footer>
            ...
            <section class="footer-section container g-pt-30">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-xs-6 col-3xs-12 pull-right text-right">
                        <h6>Copyright &copy; Kiraz Bahçesi (2016)</h6>
                    </div>
                </div>
            </section>
        </footer>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCu3_nmp2r3QzLJceJjMLgpbPpzfpHd5Tw&amp;signed_in=true&amp;callback=initMap" async defer></script>
